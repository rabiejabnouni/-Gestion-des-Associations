...
import print.print.Auth.DTO.RegistrationRequest;
import print.print.Auth.Model.AppUser;
import print.print.Auth.Model.AppUserRole;
...
public class RegistrationService {
    ...
    public String registerWithGoogle(RegistrationRequest request) {
    ...
    public String confirmToken(String token) {
        ...
        appUserService.upDate(
                confirmationToken.getAppUser().getEmail(),true);
