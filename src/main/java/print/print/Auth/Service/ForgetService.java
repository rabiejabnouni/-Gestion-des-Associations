...
public class ForgetService {
    ...
    public Boolean isConfirmed(String token ){
        Boolean isconfirmed= confirmationTokenService.getToken(token).get().getConfirmed();
        return isconfirmed;
    }



    public ConfirmationToken updatePassword(String newPassword,String email){
        String encoderPassword = bCryptPasswordEncoder.encode(newPassword);
        System.out.println(encoderPassword);
        appUserRepository.forgetAppUser(email,encoderPassword);
